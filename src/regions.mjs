// 통일 권역: 수도권 / 충청권 / 강원권 / 호남권 / 영남권 / 대구 / 울산 / 부산
export const REGIONS = ["수도권", "충청권", "강원권", "호남권", "영남권", "대구", "울산", "부산"];
...
export function clusterOf(hay) {
  ...
  if (/경북|경주|포항|안동|영주|문경|상주|구미|경산|영천|경남|창원|진주|김해|양산|거제|통영|사천|밀양|문씨어터|F1963|진해/.test(H)) return "영남권";
